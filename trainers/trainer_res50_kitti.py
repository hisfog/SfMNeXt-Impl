...
class Trainer:
    ...
    def predict_poses(self, inputs, features):
        ...
        if self.num_pose_frames == 2: # default true
    ...
    def generate_images_pred(self, inputs, outputs):
        ...
        for scale in self.opt.scales:
            ...
            if self.opt.v1_multiscale:
                ...
                depth = disp # we predict depth
            # depth = disp_to_depth_M(disp, self.opt.min_depth, self.opt.max_depth)
