...
class Depth_Decoder_QueryTr(nn.Module):
    ...
    def forward(self, x0):
        ...
        # pos = self.positional_encodings[:embeddings_0.shape[2], :].T.unsqueeze(0)        # print(embeddings_0.shape, " ==38 embeddings_0.shape")
        # res = torch.matmul(pos.permute(0, 2, 1), pos)
        # res = res.reshape(1, 200, 8, 25)
